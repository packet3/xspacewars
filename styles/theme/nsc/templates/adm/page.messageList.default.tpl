                ...
                <table class="table table-dark table-hover"> 	
                    ...
                    <tbody>
                        ...
                        <tr data-messageID="{$messageID}">
                            ...
                            <td><a href="#" class="toggle">{$messageRow.subject}{if $messageRow.deleted}&nbsp;<img src="./styles/resource/images/admin/i.gif" width="16" height="16" alt="" class="tooltip" data_tooltip_content="{$LNG.ml_deleted}">{/if}</a></td>
                        </tr>
