...
<div id="left_side">  
    ...
    <div id="left_menu">
        <div id="touchscreenleft_menu">   
            ...
            <a class="nuovomenudestra tooltip" href="game.php?page=resources" id="munu_resources" data_tooltip_content="{$LNG.lm_resources}"><img src="{$dpath}img/iconav/resources.png" class="oimgaltro"></a>
            {/if}
            <!-- flotta hangar -->
            ...
            <a class="nuovomenudestra tooltip" href="game.php?page=battleSimulator" id="munu_fleetable" data_tooltip_content="{$LNG.lm_battlesim}"><img src="{$dpath}img/iconav/target.png" class="oimgaltro"></a>	
            {/if}            
            <!-- alleanza-->
            ...
            <a class="nuovomenudestra tooltip" href="game.php?page=conteiner" id="munu_fleetable" data_tooltip_content="{$LNG.lm_container}"><img src="{$dpath}img/iconav/arsenal.png" class="oimgaltro"></a>	
            {/if}
            ...
            <a class="nuovomenudestra tooltip" href="game.php?page=details" id="munu_fleetable" data_tooltip_content="{$LNG.lm_details}"><img src="{$dpath}img/iconav/blackmarket.png" class="oimgaltro"></a>	
            {/if}
