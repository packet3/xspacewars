                ...
                <div class="col-md-6">
                    <div class="card mt-1 mr-1 background-border-black-blue shadow"> 
                        <div class="card-body">
                            ...
                            <div class="alleanza12 tooltip" data_tooltip_content="{$LNG.pl_unitsshot} {$statisticData.desunits}" style="width:{$statisticData.damageDes}%"></div>
                            <div class="alleanza13 tooltip" data_tooltip_content="{$LNG.pl_unitslose} {$statisticData.lostunits}" style="width:{$statisticData.damageLost}%"></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
