...
<div class="gray_stripe">
   <div class="imper_left_part">
    {if isModuleAvailable($smarty.const.MODULE_REDUCE_RESOURCES)}
      <a href="game.php?page=reduceResources" class="fleet_reduce1 ico_reduceresources tooltip" data_tooltip_content="{$LNG['lm_reduceresources']}"></a>
    {/if}
    {if isModuleAvailable($smarty.const.MODULE_REDUCE_FLEET)}
      <a href="game.php?page=reduceFleet" class="fleet_reduce1 ico_reducefleet tooltip" data_tooltip_content="{$LNG['lm_reducefleet']}"></a>
    {/if}
    {if isModuleAvailable($smarty.const.MODULE_DELIVERY)}
      <a href="game.php?page=delivery" class="fleet_reduce1 ico_deliveryres tooltip" data_tooltip_content="{$LNG['lm_delivery']}"></a>
    {/if}
   </div>
