...
<div id="ally_content" class="conteiner">
   <form action="game.php?page=delivery&amp;mode=delivery" method="post" id="form" onSubmit="return CheckArg();">
    ...
    {*<div class="delivress9 tooltip" data_tooltip_content="Доступно"> 4543</div>*}
