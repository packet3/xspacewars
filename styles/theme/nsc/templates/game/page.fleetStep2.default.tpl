                ...
                <div class="fleetstep2-2">
                    ...
                    <div {if $mission != 18} style="display:none;"{/if} id="listsector">
                        ...
                        <div class="label_sector">
                            <input type="radio" name="sectors" id="sector_{$IDSector}" value="{$IDSector}" class="tooltip" data_tooltip_content="{$LNG.fl_enemy_text.$IDSector}"/>
                            <label for="sector_{$IDSector}" class="tooltip" data_tooltip_content="{$LNG.fl_enemy_text.$IDSector}">{$rowSector}</label>
                        </div>
                        {/foreach}    
                    </div>
