                ...
                <div id="galactic_block_1">
                    ...
                    <div class="gal_user {if $planet != 1 && $planet != 3 && $planet != 5 && $planet != 7 && $planet != 9 && $planet != 11 && $planet != 13 && $planet != 15}second{/if}">   
                        <div class="gal_number">
                            <a href="game.php?page=fleetTable&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$planet}&amp;planettype=1" class="tooltip" data_tooltip_content="
                    ...
                    ">   
                        ...
                        {if $currentPlanet.moon}
                            <div class="ico_moon tooltip" data_tooltip_content="
                            ...
                            <div class="gl-actions" style="top: 5px;z-index: 2;padding-left: 0px;left: 44px;">
                                <table class="gl-actions-t">	
                                    <tbody>
                                        <tr>
                                            {if $currentPlanet.missions.1}<td><a class="gl-actions-i ri i-mis1 tooltip" href="?page=fleetTable&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$planet}&amp;planettype=3&amp;target_mission=1" data_tooltip_content="{$LNG.type_mission_1}"></a></td>{/if}
                                            {if $currentPlanet.missions.3}<td><a class="gl-actions-i ri i-mis3 tooltip" href="?page=fleetTable&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$planet}&amp;planettype=3&amp;target_mission=3" data_tooltip_content="{$LNG.type_mission_3}"></a></td>{/if}
                                            {if $currentPlanet.missions.4}<td><a class="gl-actions-i ri i-mis4 tooltip" href="?page=fleetTable&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$planet}&amp;planettype=3&amp;target_mission=4" data_tooltip_content="{$LNG.type_mission_4}"></a></td>{/if}
                                            {if $currentPlanet.missions.5}<td><a class="gl-actions-i ri i-mis5 tooltip" href="?page=fleetTable&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$planet}&amp;planettype=3&amp;target_mission=5" data_tooltip_content="{$LNG.type_mission_5}"></a></td>{/if}	            
                                            {if $currentPlanet.missions.6}<td><a class="gl-actions-i ri i-mis6 tooltip" href='javascript:doit(6,{$currentPlanet.moon.id});' data_tooltip_content="{$LNG.type_mission_6}"></a></td>{/if}
                                            {if $currentPlanet.missions.9}<td><a class="gl-actions-i ri i-mis9 tooltip" href="?page=fleetTable&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$planet}&amp;planettype=3&amp;target_mission=9" data_tooltip_content="{$LNG.type_mission_9}"></a></td>{/if}	            
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
