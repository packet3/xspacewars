    ...
    <div id="content">
        ...
        <div id="ally_content" class="conteiner conteinership">
            ...
            <div class="fleet_log">
                ...
                <div class="fleet_time">
                    ...
                    <div class="tooltip fleet_static_time" data_tooltip_content="{$fleet.resttime1}">{$fleet.resttime1}</div>
                </div>
        ...
        <div id="ally_content" class="conteiner">
            <div class="gray_flettab">
                ...
                <div id="gm_linck">
                    <a title="" href="game.php?page=ticket" class="tooltip" data_tooltip_content="{$LNG.ov_ticket_tooltip}">{$LNG.ov_ticket}</a>  
                </div>
            </div> 
                                    ...
                                    {if $Moon}
                                        <div>
                                            ...
                                            <a href="game.php?page=overview&amp;cp={$Moon.id}&amp;re=0" class=" ">
                                                <img src="{$dpath}img/content/moon.png" class="overvieew4 tooltip" data_tooltip_content="{$Moon.name}" style="opacity:0.8">
                                            </a>
                                        </div>
                                    {else}
                                        <div>
