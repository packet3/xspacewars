                                        ...
                                        <div class="col-6">
                                            <div class="card background-border-black-blue shadow"> 
                                                <div class="card-body">
                                                    ...
                                                    <div class="alleanza12 tooltip" data_tooltip_content="{$LNG.pl_unitsshot} {$desunits}" style="width:{$damageDes}%"></div>
                                                    <div class="alleanza13 tooltip" data_tooltip_content="{$LNG.pl_unitslose} {$lostunits}" style="width:{$damageLost}%"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
