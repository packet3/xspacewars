    ...
    <div class="col-6">
        <div class="card-custom m-1 background-border-black-blue shadow"> 
            <div class="card-body-custom">
                ...
                <p class="card-title-custom text-align-right">{$LNG.in_attack_pt}</p>
                <p class="card-text-custom text-align-right gradient-gray">{$FleetInfo.attack|number}</p>
            </div>
        </div>
    </div>
    {else}
    ...
    <div class="col-6">
        <div class="card-custom m-1 background-border-black-blue shadow"> 
            <div class="card-body-custom">
                ...
                <p class="card-title-custom text-align-right">{$LNG.in_attack_laser}</p>
                <p class="card-text-custom text-align-right gradient-gray">{$FleetInfo.fleetgun.laser.attack|number}</p>
            </div>
        </div>
    </div>
    {/if}
    ...
    <div class="col-6">
        <div class="card-custom m-1 background-border-black-blue shadow"> 
            <div class="card-body-custom">
                ...
                <p class="card-title-custom text-align-right">{$LNG.in_attack_ionic}</p>
                <p class="card-text-custom text-align-right gradient-gray">{$FleetInfo.fleetgun.ion.attack|number}</p>
            </div>
        </div>
    </div>
    {/if}
    ...
    <div class="col-6">
        <div class="card m-1 background-border-black-blue shadow"> 
            <div class="card-body-custom">
                ...
                <p class="card-title-custom text-align-right">{$LNG.in_attack_buster}</p>
                <p class="card-text-custom text-align-right gradient-gray">{$FleetInfo.fleetgun.plasma.attack|number}</p>
            </div>
        </div>
    </div>        
    {/if}
    ...
    <div class="col-6">
        <div class="card-custom m-1 background-border-black-blue shadow"> 
            <div class="card-body-custom">
                ...
                <p class="card-title-custom text-align-right">{$LNG.in_attack_graviton}</p>
                <p class="card-text-custom text-align-right gradient-gray">{$FleetInfo.fleetgun.gravity.attack|number}</p>
            </div>
        </div>
    </div>
    {/if}
    ...
    <div class="col-6">
        <div class="card-custom m-1 background-border-black-blue shadow"> 
            <div class="card-body-custom">
                ...
                <p class="card-title-custom text-align-right">{$LNG["in_armor_{$FleetInfo.info.class_defend}"]}</p>
                <p class="card-text-custom text-align-right gradient-gray">{$FleetInfo.structure|number}</p>
            </div>
        </div>
    </div>
    ...
    <div class="col-6">
        <div class="card-custom m-1 background-border-black-blue shadow"> 
            <div class="card-body-custom">
                ...
                <p class="card-title-custom text-align-right">{$LNG["in_shield_{$FleetInfo.info.class_shield}"]}</p>
                <p class="card-text-custom text-align-right gradient-gray">{$FleetInfo.shield|number}</p>
            </div>
        </div>
    </div>
    {/if}
    ...
    <div class="col-4">
        <div class="card-custom m-1 background-border-black-blue shadow"> 
            <div class="card-body-custom">
                ...
                <p class="card-title-custom text-align-right">{$LNG.in_consumption}</p>
                <p class="card-text-custom text-align-right gradient-gray">{$FleetInfo.consumption1|number}{if $FleetInfo.consumption1 != $FleetInfo.consumption2}({$FleetInfo.consumption2|number}){/if}</p>
            </div>
        </div>
    </div>
    {/if}
    ...
    <div class="col-4">
        <div class="card-custom m-1 background-border-black-blue shadow"> 
            <div class="card-body-custom">
                ...
                <p class="card-title-custom text-align-right">{$LNG.in_capacity}</p>
                <p class="card-text-custom text-align-right gradient-gray">{$FleetInfo.capacity|number}</p>
            </div>
        </div>
    </div>
    {/if}
...
<div class="row background-border-black-gray m-1">
    ...
    <div class="col-6">
        <div class="card-custom m-1 background-border-black-blue shadow"> 
            <div class="card-body-custom">
                <p class="card-title-custom text-align-right">{$LNG.in_rf_again}</p>
                <div class="row">
    ...
    <div class="col-6">
        <div class="card-custom m-1 background-border-black-blue shadow"> 
            <div class="card-body-custom">
                <p class="card-title-custom text-align-right">{$LNG.in_rf_from}</p>
                <div class="row">
