    ...
    <div class="col-4">
        <div class="card m-1 background-border-black-blue shadow"> 
            <div class="card-body">
                ...
                <div class="card-img-left opacity-70 tooltip" style="background:url({$dpath}img/information/comb.png)" data_tooltip_content="{$LNG.tech.115}"></div> 
                {elseif $FleetInfo.tech == 2 || $FleetInfo.tech == 5}
                <div class="card-img-left opacity-70 tooltip" style="background:url({$dpath}img/information/imp.png)" data_tooltip_content="{$LNG.tech.117}"></div> 
                {else}
                <div class="card-img-left opacity-70 tooltip" style="background:url({$dpath}img/information/hyper.png)" data_tooltip_content="{$LNG.tech.118}"></div> 
                {/if} 
                ...
                {foreach $FleetInfo.rapidfire.to as $rapidfireID => $shoots}
                    <div class="col-2">
                        <div class="card background-border-black-blue m-1"> 
                            <span class="card-img-text background-color-blue opacity-70 tooltip" data_tooltip_content="{$LNG.in_number}">{$shoots|number}</span>
                            <img src="{$dpath}gebaeude/{$rapidfireID}.gif" alt="{$LNG.tech.$rapidfireID}" class="opacity-70 tooltip" data_tooltip_content="{$LNG.tech.$rapidfireID}">
                        </div>
                    </div>
                {/foreach}
                </div>
        ...
        <div class="card m-1 background-border-black-blue shadow"> 
            <div class="card-body">
                ...
                {foreach $FleetInfo.rapidfire.from as $rapidfireID => $shoots}
                    <div class="col-2">
                        <div class="card background-border-black-blue m-1"> 
                            <span class="card-img-text background-color-red opacity-70 tooltip" data_tooltip_content="{$LNG.in_number}">{$shoots|number}</span>
                            <img src="{$dpath}gebaeude/{$rapidfireID}.gif" alt="{$LNG.tech.$rapidfireID}" class="opacity-70 tooltip" data_tooltip_content="{$LNG.tech.$rapidfireID}">
                        </div>
                    </div>
                {/foreach}
