...
<div id="content_battle">
    ...
    <div id="raports">
                    ...
                    <div class="batle_mem_content" {if $RoundInfo@last}style="display:block;"{/if}>
						{foreach $Player.ships as $ShipID => $ShipData}	
   		    	        <div class="batle_unit">
                            <div class="img_unit tooltip" style="cursor:help !important" data_tooltip_content="
                                <table>
                                    <tr>
                            ...
                            <span class="tooltip" data-real="{$ShipData[0]|number}" data_tooltip_content="{$ShipData[0]|number}">{pretty_number($ShipData[0])}</span><br/>
        ...
        {if !$RoundInfo@last}
        <div class="band_att tooltip" style="cursor:help !important" data_tooltip_content="{$LNG.fleet_attack_1} {$RoundInfo.info[0]|number} {$LNG.fleet_attack_2} {$RoundInfo.info[3]|number} {$LNG.damage}<br> {$LNG.fleet_defs_1} {$RoundInfo.info[2]|number} {$LNG.fleet_defs_2} {$RoundInfo.info[1]|number} {$LNG.damage}">
            <div class="ico_part">
...
<!--ITOG-->
    ...
    <div class="band_itog tooltip" style="cursor:help !important" data_tooltip_content="
